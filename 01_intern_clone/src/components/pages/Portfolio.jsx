...
const TaskHeroSection = () => {
  return (
    <div className="relative w-full flex justify-center items-start pt-8 overflow-hidden">
      ...
      {/* Main Content */}
      <div className='relative z-10 text-center mt-20 max-w-6xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-8'>
          <div className='inline-flex justify-center items-center border bg-green-800/50 rounded-full px-4 py-1 gap-2'>
            ...
            <h1 className='text-[#319c1c] text-sm sm:text-base'>Task Management Platform</h1>
          </div>
        </div>
        ...
        <div className='space-y-6'>
          ...
          <h1 className='text-white text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight'>internee.pk</h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 mt-10">
          {/* First Card */}
          <div className="flex flex-col gap-4 p-6 sm:p-8 w-full md:w-[40rem] bg-[#1f1f1f] rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
            <div className="flex flex-col gap-4">
              <div className="rounded-xl bg-[#002e06] p-3 w-fit">
                <PiBag className="text-[#319c1c] text-3xl" />
              </div>
              <h2 className="text-white text-xl sm:text-2xl font-semibold text-left">
                Hands-on Industry Projects with internee.pk
              </h2>
            </div>
            <p className="text-[#8A99A5] text-sm sm:text-base text-left">
            ...
            <div className="flex flex-col gap-3 mt-2">
              {["Project-based learning", "Industry-standard practices", "Portfolio building"].map((item, index) => (
                <div className="flex items-center gap-2" key={index}>
                  ...
                  <span className="text-[#8A99A5] text-sm sm:text-base">{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className='bg-[#1f1f1f] rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 p-6'>
            <div className='flex gap-4 md:gap-6 items-start'>
              ...
              <div className='flex flex-col gap-2'>
                <h1 className='text-white text-xl sm:text-2xl font-semibold text-left'>
                  SDLC Implementation via internee.pk
                </h1>
                <p className='text-[#8A99A5] text-sm sm:text-base text-left leading-relaxed'>
        ...
        <div className='flex justify-center mt-16 px-4 mb-20'>
          <div className='bg-[#1f1f1f] rounded-2xl shadow-lg p-6 sm:p-10 w-full max-w-7xl hover:scale-105 transition-transform duration-300'>
            ...
            <div className='flex flex-col gap-4 items-center text-center'>
              ...
              <p className='text-[#8A99A5] text-sm sm:text-base max-w-3xl'>
              ...
              <div className='flex items-center gap-2 mt-4'>
                <button className='bg-[#319c1c] flex items-center text-white px-4 sm:px-6 py-3 rounded-2xl cursor-pointer hover:bg-[#267c15] transition-colors font-medium text-base sm:text-lg'>
                  Start Your Journey Now
                  <span className="ml-2"><MdNavigateNext size={20} className='text-white' /></span>
                </button>
              </div>
