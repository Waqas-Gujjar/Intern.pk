...
const StudentAmbassador = () => {
  return (
    <div className="w-full bg-[#121212] h-[125rem] relative">
      {/* Background Image */}
      <img
        src={background}
        alt="background"
      ...
      <div className="w-full mt-[-9rem] relative  h-screen ">
        <div className="bg-[#1e1e1e] ml-25 flex flex-col items-start h-[60rem]   mr-5 px-8 py-6   rounded-xl shadow-lg">
          <h1 className="text-white text-xl font-semibold">Become a Student Ambassador</h1>
          ...
          <div className='mt-69 absolute flex ml-50 '>
            <img src={photo} alt="photo" className='h-140  object-cover rounded-xl' />
          </div>
          <div className='flex h-[17.5rem] relative rounded-2xl p-8 items-start justify-center w-[34rem] top-76  left-115 bg-black flex-col'>
            <div className='w-[28rem]  ' >
              <h1 className='text-6xl text-white font-bold'>Unlock Your Potential</h1>
              <p className='text-gray-300 text-lg font-semibold   mt-6 '>Discover new opportunities and enhance your skills.
      ...
      <div className='top-[16rem] relative'>
        <div className="text-white text-xl relative m] font-bold px-8 mt-20 mb-6">
          <h3>Why you should join</h3>
        </div>

        {/* Card Section */}
        <div className="text-white relative px-8">
  <div className="flex justify-between gap-6   items-center ">
    {card.map((car, index) => (
      ...
      >
        <div className="mb-4 text-[#43a724]">
          {car.icon}
        </div>
