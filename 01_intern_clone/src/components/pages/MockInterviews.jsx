      ...
      <div className="relative z-10 w-full h-full px-6 py-20 flex items-center justify-center">
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center mt-16">
            ...
            {/* CTA Button */}
            <button
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 mt-10 rounded-2xl cursor-pointer transition w-max"
              type="button"
              // Add your onClick handler or Link here
            >
