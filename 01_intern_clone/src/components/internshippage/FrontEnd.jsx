...
import htmlcssjs from "../../assets/images/image/frontend/htmlcssjs.png";
import react from "../../assets/images/image/frontend/react.png";
import wordpress from "../../assets/images/image/frontend/wordpress.png";
import angular from "../../assets/images/image/frontend/angular.png";
import django from "../../assets/images/image/frontend/django.jpg";
import net from "../../assets/images/image/frontend/net.png";
import nextjs from "../../assets/images/image/frontend/nextjs.png";
  ...
  return (
    <div className="mt-20 min-h-screen bg-black">
      ...
      <div className="flex bg-[#004207] mt-26 p-24 rounded-2xl mx-20 justify-center items-center text-center">
        <h3 className="text-white text-5xl font-bold">Frontend Internship</h3>
      </div>
